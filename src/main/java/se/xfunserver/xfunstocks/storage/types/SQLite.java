...
public class SQLite extends Storage {
    ...
    protected HikariConfig buildHikariConfig(SqlSettings settings) {
        ...
        config.setJdbcUrl("jdbc:sqlite:plugins/xFunStocks/xFunStocks.db");
    ...
    protected String getCreateTableQuery() {
        return "CREATE TABLE IF NOT EXISTS xfunstock_transactions(id INTEGER PRIMARY KEY, uuid CHAR(36), "
                + "type VARCHAR(8), date DATETIME, symbol VARCHAR(12), quantity INTEGER, single_price "
                + "VARCHAR(20), earnings VARCHAR(20), sold BOOLEAN)";
    }
